...
GLuint Renderer::currentTextureID;
...
void Renderer::Initialize()
{
    ...
    // Load Textures
#if defined(PLATFORM_OSX)
	GLuint greengrassTextureID = LoadTexture("Textures/greengrass.png");
	GLuint purplemetalTextureID = LoadTexture("Textures/purplemetal.jpg");
#else
	GLuint purplemetalTextureID = LoadTexture("../Assets/Textures/purplemetal.jpg");
	GLuint greengrassTextureID = LoadTexture("../Assets/Textures/greengrass.png");
#endif

	currentTextureID = greengrassTextureID;
...
GLuint Renderer::LoadTexture(char* imagepath)
{
